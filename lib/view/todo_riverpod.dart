...
//         onPressed: () {
//           final newTaskIndex = todoList.state.length + 1;
//           final newTask = 'New Task $newTaskIndex';
//
//           final updatedList = [...todoList.state, newTask];
//           ref.read(todoListProvider.notifier).state = updatedList;
//         },
